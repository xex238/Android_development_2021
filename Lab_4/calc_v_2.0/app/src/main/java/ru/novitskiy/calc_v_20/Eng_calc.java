...
public class Eng_calc extends AppCompatActivity
{
    ...
    public void Set_uniteral_operation(View view)
    {
        ...
        double value = Double.valueOf(buffer.substring(start_num_pos, end_num_pos));
        double result = 0.0;
        ...
        try
        {
            switch (btn_id)
            {
                ...
                case R.id.button_sqrt:
                    ...
                    break;
                case R.id.rev_num_button:
                    result = 1 / value;
                    break;
                case R.id.button_degree_2:
                    result = Math.pow(value, 2);
                    break;
                case R.id.button_10_degree_x:
            ...
            if(result == (int)result)
            {
                ...
                result_string = String.valueOf(result_int);
            }
            else
            {
            ...
            new_buffer += result_string;

            numbers.remove(numbers.size() - 1);
            numbers.add(Double.valueOf(result_string));

            end_num_pos = start_num_pos + result_string.length();
            Change_end_num(end_num_pos);
            //---------------
    ...
    public void Set_equals(View view)
    {
        ...
        try
        {
            for(int i=0; i<signs.size(); i++)
            {
                ...
                {
                    case "log":
                        result = Math.log(numbers.get(i + 1)) / Math.log(numbers.get(i));
                        Shift(i, result);
                        i--;
                        break;
                }
